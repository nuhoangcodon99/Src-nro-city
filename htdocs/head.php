...
<head>
    ...
    <meta name="description"
        content="ngocrong,ngocrongonline,ngocrongcity.online,7vienngocrong,nro">
    <meta name="keywords"
        content="Ngọc Rồng City - Máy Chủ Ngọc Rồng Online Online,ngoc rong mobile, game ngoc rong, game 7 vien ngoc rong, game bay vien ngoc rong">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title"
        content="Website chính thức của Ngọc Rồng Citu - Máy Chủ Ngọc Rồng Online Online – Game Bay Vien Ngoc Rong Mobile nhập vai trực tuyến trên máy tính và điện thoại về Game 7 Viên Ngọc Rồng hấp dẫn nhất hiện nay!">
    <meta name="twitter:description"
        content="Website chính thức của Ngọc Rồng City - Máy Chủ Ngọc Rồng Online Online – Game Bay Vien Ngoc Rong Mobile nhập vai trực tuyến trên máy tính và điện thoại về Game 7 Viên Ngọc Rồng hấp dẫn nhất hiện nay!">
            ...
            <div class="row bg pb-3 pt-2">
                <div class="col">
                    <div class="text-center mb-2">
                        <a href="../index"><img class="rounded" src="../image/1.png" id="logo"></a>
                    </div>
                    <div class="text-center pt-2">
                        <div style="display: inline-block;">
                            <a href="https://1drv.ms/u/s!AvoiwdBY-YIGsFt3cCIQWpyKP2dj?e=LM5YmH?usp=drive_link"> <img class="icon-download" src="../image/android.png">
                            </a><br>
                            <small class="text-dark">
                                <?php echo $_android; ?> <img src="image/hot.gif"></a>
                            </small>
                        </div>
                        <div style="display: inline-block;">
                            <a href="https://drive.google.com/file/d/1ioc7tzZe7gjZhYt7r7lHM3VdlB3Y1w0w/view?usp=drive_link"><img class="icon-download" src="../image/pc.png">
                            </a><br>
                            <small class="text-dark">
                                <?php echo $_windows; ?> <img src="image/hot.gif"></a>
                            </small>
                        </div>
                        <div style="display: inline-block;">
                        <a href="https://drive.google.com/file/d/1LNBVpJEXWQJP-gev-Gnp4cOTnjFJNtZD/view?usp=drive_link"><img class="icon-download" src="../image/ip.png">
						</a><br>
                            <small class="text-dark">
                                <?php echo $_iphone; ?> <img src="image/hot.gif"></a>
                            </small>
                        ...
                        <a href="https://zalo.me/0343214443"><img class="icon-download" src="../image/zalo.png">
                            ...
                            <small class="text-dark">
                                <?php echo $_Zalo; ?> <img src="image/hot.gif"></a>
                            </small>
                        </div>
                        <div>
        ...
        <?php if ($_login == null) { ?>
            <div class="container color-main2 pb-2">
                <div class="text-center">
					...
					<div class="col pr-0"> <a href="gioi-thieu" class="btn p-1 btn-header">Giới thiệu</a> </div>
