...
public class SkillUtil {
    ...
    public static int getPercentKiBienHinh(int level) { //tỉ lệ máu khỉ cộng thêm v
        return (level + 3) * 10;
    }
    
    public static int getPercentDameBienHinh(int level) { //tỉ lệ dam khỉ cộng thêm v
        return (level + 3);
    }    
...
//        return 10000;
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id >= 1476 && id <= 1482) {
            return Skill.LIEN_HOAN_CHUONG;
        } else if (id >= 1468 && id <= 1474) {
            return Skill.MA_PHONG_BA;
        } else if (id >= 1460 && id <= 1466) {
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1476 && tempId <= 1482) {
            return getSkillbyId(pl, Skill.LIEN_HOAN_CHUONG);
        } else if (tempId >= 1468 && tempId <= 1474) {
            return getSkillbyId(pl, Skill.MA_PHONG_BA);
        } else if (tempId >= 1460 && tempId <= 1466) {
