                    ...
                    for (Player plBoss : listBoss) {
                        if (plBoss != null) {
                            if (pl.playerTask.taskMain.id != 19 && (plBoss.id == BossID.KUKU || plBoss.id == BossID.MAP_DAU_DINH || plBoss.id == BossID.RAMBO)) {
                                ...
                                Service.getInstance().sendThongBaoOK(pl, " changeZone Trong thời gian hỗ trợ\nKhông thể vào khu vực này");
                                return;
                            }
...
//                    }
                    ...
                    if (!isBoss && this.iDMark.isGotoBTDN() && Util.canDoWithTime(this.iDMark.getLastTimeGoToBTDN(), 6000)) {
                        ChangeMapService.gI().changeMapInYard(this, 180, -1, 174);
                        this.iDMark.setGotoBTDN(false);
                    }
                    if (this.zone != null) {
