package com.girlkun.models.boss.list_boss.BayTangDiaNguc;
 ...
 *  @author TonyD
 */
public class Mihac extends Boss {

    private static final int[][] FULL_DEMON = new int[][]{{Skill.DEMON, 1}, {Skill.DEMON, 2}, {Skill.DEMON, 3}, {Skill.DEMON, 4}, {Skill.DEMON, 5}, {Skill.DEMON, 6}, {Skill.DEMON, 7}};
    private int levell;

    public Mihac(Zone zone, int level, int dame, int hp) throws Exception {
        super(BossID.MINUONG, new BossData(
                "Mị Hắc", //name
                ConstPlayer.TRAI_DAT, //gender
                new short[]{1522, 1523, 1524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
   ...
   @Override
    public void reward(Player plKill) {
        if (levell < 20) {
            ...
            ItemMap itemMap;
            itemMap = Util.ratiItem(zone, 1950, 1, this.location.x, this.location.y, plKill.id);
            itemMap.options.add(new Item.ItemOption(50, Util.nextInt(20, 25)));
            itemMap.options.add(new Item.ItemOption(77, Util.nextInt(10, 15)));
            itemMap.options.add(new Item.ItemOption(103, Util.nextInt(10, 15)));
            itemMap.options.add(new Item.ItemOption(117, Util.nextInt(3, 6)));
            ...
            itemMap.options.add(new Item.ItemOption(77, Util.nextInt(15, 20)));
            itemMap.options.add(new Item.ItemOption(103, Util.nextInt(15, 20)));
            itemMap.options.add(new Item.ItemOption(117, Util.nextInt(6, 9)));
            itemMap.options.add(new Item.ItemOption(30, 0));
            Service.getInstance().dropItemMap(this.zone, itemMap);
        } else {
            ItemMap itemMap;
            ...
            ItemMap itemMap;
            itemMap = Util.ratiItem(zone, 1950, 1, this.location.x, this.location.y, plKill.id);
            itemMap.options.add(new Item.ItemOption(50, Util.nextInt(30, 35)));
            ...
            itemMap.options.add(new Item.ItemOption(117, Util.nextInt(9, 12)));
            itemMap.options.add(new Item.ItemOption(30, 0)); 
            Service.getInstance().dropItemMap(this.zone, itemMap);
        } else {
            ItemMap itemMap;
            ...
            itemMap.options.add(new Item.ItemOption(117, Util.nextInt(12, 15)));
            itemMap.options.add(new Item.ItemOption(30, 0));
            Service.getInstance().dropItemMap(this.zone, itemMap);
        } else {
            ItemMap itemMap;
        ...
        if (levell <= 30000) {
            if (Util.isTrue((levell / 1000), 100) && plAtt != null) {//tỉ lệ hụt của thiên sứ
                ...
                if (Util.isTrue(1, 100)) {
                    this.chat("Gà đánh mạnh lên");
                } else if (Util.isTrue(1, 100)) {
                    this.chat("Ngậm hành đi hahaha");
                }
                damage = 0;
            }
        } else {
