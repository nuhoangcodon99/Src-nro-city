 ...
 */
public class HaChiYack extends Boss {

    private static final int[][] FULL_DEMON = new int[][]{{Skill.DEMON, 1}, {Skill.DEMON, 2}, {Skill.DEMON, 3}, {Skill.DEMON, 4}, {Skill.DEMON, 5}, {Skill.DEMON, 6}, {Skill.DEMON, 7}};
    private int levell;

    public HaChiYack(Zone zone, int level, int dame, int hp) throws Exception {
    ...
    public void reward(Player plKill) {
        if (levell < 20) {
            ...
            ItemMap itemMap;
            itemMap = Util.ratiItem(zone, 729, 1, this.location.x, this.location.y, plKill.id);
            ...
            itemMap.options.add(new Item.ItemOption(103, Util.nextInt(30, 35)));
            itemMap.options.add(new Item.ItemOption(30, 0)); 
            Service.getInstance().dropItemMap(this.zone, itemMap);
        } else {
            ItemMap itemMap;
