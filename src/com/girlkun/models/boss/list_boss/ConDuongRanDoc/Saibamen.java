...
public class Saibamen extends Boss {
    ...
    private int levell;
    public Saibamen(Zone zone , int level, int dame, int hp) throws Exception {
        ...
        if (!this.isDie()) {
            ...
            if (this.nPoint.hp == 0) {
                try {
                    ...
                    new Saibamen2(this.zone, plAtt.clan.ConDuongRanDoc.level, Util.nextInt(1000, 10000), BossID.SAIBAMEN_1);
