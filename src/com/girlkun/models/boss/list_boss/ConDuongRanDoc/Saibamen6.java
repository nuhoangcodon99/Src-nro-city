...
public class Saibamen6 extends Boss {
    ...
    private int levell;
    public Saibamen6(Zone zone , int level, int dame, int hp) throws Exception {
        super(BossID.BLACK, new BossData(
                "số 6",
        ...
        if (!this.isDie()) {
            ...
            if (this.nPoint.hp == 0) {
                try {
                 ...
                 new Nappa(this.zone, plAtt.clan.ConDuongRanDoc.level, Util.nextInt(1000, 10000), BossID.SAIBAMEN_6);      
