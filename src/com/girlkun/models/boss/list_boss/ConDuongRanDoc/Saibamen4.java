...
public class Saibamen4 extends Boss {
    private static final int[][] FULL_DEMON = new int[][]{{Skill.DEMON, 1}, {Skill.DEMON, 2}, {Skill.DEMON, 3}, {Skill.DEMON, 4}, {Skill.DEMON, 5}, {Skill.DEMON, 6}, {Skill.DEMON, 7}};
    private int levell;
    public Saibamen4(Zone zone , int level, int dame, int hp) throws Exception {
    ...
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            ...
            if (this.nPoint.hp == 0) {
                ...
                new Saibamen5(this.zone, plAtt.clan.ConDuongRanDoc.level, Util.nextInt(1000, 10000), BossID.SAIBAMEN_4);    
