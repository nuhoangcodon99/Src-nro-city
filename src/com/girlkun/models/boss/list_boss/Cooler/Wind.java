 ...
 *@Stole By Arriety
 */
public class Wind extends Boss {

    public Wind() throws Exception {
        super(BossID.WIND, BossesData.WIND);
    }
    ...
    public void reward(Player plKill) {
       int[] itemDos = new int[]{2152,2153,2154,2155};
        ...
        if (Util.isTrue(100, 100)) {
            ...
            Service.gI().dropItemMap(this.zone, Util.useItem2(zone, itemDos[randomDo], 33, this.location.x, this.location.y, plKill.id));
         }
    }
 @Override
