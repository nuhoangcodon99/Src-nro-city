...
//     }
    ...
    public static void initMobBayTangDiaNguc(Mob mob, byte level) {
        mob.point.dame = level * 3250 * mob.level * 4;
        mob.point.maxHp = level * 12472 * mob.level * 2 + level * 7263 * mob.tempId;
    }
        ...
        if (this.isDie()&& !Maintenance.isRuning) {
            switch (zone.map.type) {
                ...
                case ConstMap.MAP_BAN_DO_KHO_BAU:
                    ...
                    break;
                    case ConstMap.MAP_BAY_TANG_DIA_NGUC:
                        break;
                default:
...
//                MobService.gI().mobAttackPlayer(this, pl);
    ...
    public List<ItemMap> getItemMobReward(Player player, int x, int yEnd) {
        ...
        if (player.itemTime.isUseMayDo2 && Util.isTrue(1, 500) && this.tempId != 0) { //máy dò vàng
            list.add(new ItemMap(zone, 457, 1, x, player.location.y, player.id));
        }
        if (player.cFlag>=1 && Util.isTrue(10, 100) && this.zone.map.mapId>=79 && this.zone.map.mapId<=83) {    //đuôi khỉ
            list.add(new ItemMap(zone, 579, 1, x, player.location.y, player.id));// cai nay sua sau nha
        }        
//        if (Util.isTrue(10, 100) && this.tempId != 0) {
...
//        } 
        ...
        if (Util.isTrue(30, 100)) {    //hop the btc2 ms farm dc btc3
        ...
        if (this.tempId>0 && this.zone.map.mapId>=156 && this.zone.map.mapId<=159){
        if (Util.isTrue(10, 100)) {    //mhbt
            list.add(new ItemMap(zone, 934, 1, x, player.location.y, player.id));}}
        if (this.tempId>0 && this.zone.map.mapId>=156 && this.zone.map.mapId<=159){
        if (Util.isTrue(5, 100)) {    //đá xanh lam
            list.add(new ItemMap(zone, 935, 1, x, player.location.y, player.id));}}
        //roi ngocrong
        if (Util.isTrue(1, 47) && this.tempId != 0) {
            list.add(new ItemMap(zone, 20, 1, x, player.location.y, player.id));// cai nay sua sau nha
        } 
        if (Util.isTrue(1, 51) && this.tempId != 0) {
            list.add(new ItemMap(zone, 19, 1, x, player.location.y, player.id));// cai nay sua sau nha
        } 
        if (Util.isTrue(1, 55) && this.tempId != 0) {
            list.add(new ItemMap(zone, 18, 1, x, player.location.y, player.id));// cai nay sua sau nha
        } 
        //rơi spl 
        if (Util.isTrue(1, 100) && this.tempId != 0) {
        ...
        //roi manh thien su
        if (player.setClothes.setDHD == 5 && Util.isTrue(1, 500) && MapService.gI().isMapCold(this.zone.map)) {
        ...
        if (this.zone.map.mapId >= 202 && this.zone.map.mapId <= 203) {
            if(Util.isTrue(10, 100)){
                Item longlinhthu = ItemService.gI().createNewItem((short) (2152));
                longlinhthu.itemOptions.add(new Item.ItemOption(30, 1));
                InventoryServiceNew.gI().addItemBag(player, longlinhthu);
                InventoryServiceNew.gI().sendItemBags(player);
                Service.gI().sendThongBao(player, "Bạn vừa nhận được "+longlinhthu.template.name);
                            }}
        ...
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -50, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -40, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -30, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -20, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -10, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level > 50 && player.clan.KhiGaHuyDiet.level < 100) {
        ...
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level >= 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -100, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level >= 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -90, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level >= 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -80, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level >= 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -70, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level >= 100) {
            if(Util.isTrue(2, 150)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -60, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
                            }}
        if (this.zone.map.mapId >= 147 && this.zone.map.mapId <= 152 && player.clan.KhiGaHuyDiet.level >= 100) {
        ...
        if (this.zone.map.mapId >= 141 && this.zone.map.mapId <= 143 && player.clan.ConDuongRanDoc.level > 50 && player.clan.ConDuongRanDoc.level < 100) { 
        ...
        if (this.zone.map.mapId >= 141 && this.zone.map.mapId <= 143 && player.clan.ConDuongRanDoc.level >= 100) {
            if(Util.isTrue(4, 100)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -100, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
        ...
        if (this.zone.map.mapId >= 180 && this.zone.map.mapId <= 182 && player.clan.BayTangDiaNguc.level > 50 && player.clan.BayTangDiaNguc.level < 100) {
            if(Util.isTrue(4, 100)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -50, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
        ...
        if (this.zone.map.mapId >= 180 && this.zone.map.mapId <= 182 && player.clan.BayTangDiaNguc.level >= 100) {
            if(Util.isTrue(4, 100)){
                ItemMap it = new ItemMap(this.zone, 861, 500 , this.location.x -100, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), player.id);
            Service.getInstance().dropItemMap(this.zone, it);
        ...
        if (this.zone.map.mapId >= 171 && this.zone.map.mapId <= 173) {
            if(Util.isTrue(50, 100)){
                Item Bikiep = ItemService.gI().createNewItem((short) (590));
                Bikiep.itemOptions.add(new Item.ItemOption(30, 1));
                InventoryServiceNew.gI().addItemBag(player, Bikiep);
                InventoryServiceNew.gI().sendItemBags(player);
                Service.gI().sendThongBao(player, "Bạn vừa nhận được "+Bikiep.template.name);
                            }}
        if (this.zone.map.mapId >= 204 && this.zone.map.mapId <= 210) {
            if(Util.isTrue(10, 100)){
                Item hoabingan = ItemService.gI().createNewItem((short) (2044));
                hoabingan.itemOptions.add(new Item.ItemOption(30, 1));
                InventoryServiceNew.gI().addItemBag(player, hoabingan);
                InventoryServiceNew.gI().sendItemBags(player);
                Service.gI().sendThongBao(player, "Bạn vừa nhận được "+hoabingan.template.name);
                            }}
        if (this.tempId == 0) {
        ...
        if (this.zone.map.mapId >= 212 && this.zone.map.mapId <= 215) {
            if(Util.isTrue(10, 100)){
                Item Dahoangkim = ItemService.gI().createNewItem((short) (1318));
                Dahoangkim.itemOptions.add(new Item.ItemOption(30, 1));
