...
//                }
        ...
        if (this.isMapConDuongRanDoc(mapId)) {
            ...
            return player.clan.ConDuongRanDoc.getMapById(mapId);
                ...
                if (this.isMapBayTangDiaNguc(mapId)) {
            if (player.clan == null || player.clan.BayTangDiaNguc == null) {
                return null;
            }
            if (this.isMapBayTangDiaNguc(player.zone.map.mapId)) {
                for (Mob mob : player.zone.mobs) {
                    if (!mob.isDie()) {
                        return null;
                    }
            ...
            return player.clan.BayTangDiaNguc.getMapById(mapId);
        }
        //**********************************************************************
    ...
    public boolean isMapBayTangDiaNguc(int mapId) {
        return mapId == 180 || mapId == 181 || mapId == 182 || mapId == 183;
    }
