...
public class SkillService {
    ...
    private void userSkillSpecial(Player player, Player plTarget, byte st, byte skillId, Short dx, Short dy, byte dir, Short x, Short y) {
        switch (skillId) {
    ...
    public void learSkillSpecial1(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 2);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial2(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 3);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial3(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 4);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial4(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 5);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial5(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 6);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial6(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 7);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial7(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 8);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    public void learSkillSpecial8(Player player, byte skillID) {
        Message message = null;
        try {
            Skill curSkill = SkillUtil.createSkill(skillID, 9);
            SkillUtil.setSkill(player, curSkill);
            message = Service.getInstance().messageSubCommand((byte) 23);
            message.writer().writeShort(curSkill.skillId);
            player.sendMessage(message);
    ...
    private void useSkillAlone(Player player) {
        ...
        switch (player.playerSkill.skillSelect.template.id) {
          ...
          case Skill.BIEN_HINH:
                    ...
                    RadarService.getInstance().setIDAuraEff(player, player.getAura());
                    ...
                    if (!MapService.gI().isMapOffline(player.zone.map.mapId)) {
                        ...
                        for (Player pl : playersMap) {
                           try {
                            ...
                            else if (!pl.isBoss && pl.gender != ConstPlayer.NAMEC
                        ...
                        // Xử lý ngoại lệ NullPointerException ở đây
                        e.printStackTrace(); // In stack trace để xác định nguyên nhân lỗi
                    }
