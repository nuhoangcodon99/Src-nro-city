        ...
        if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
            ...
            switch (idTaskCustom) {
                ...
                case ConstTask.TASK_20_6:
                    npcSay(player, ConstNpc.CUI,
                            "Cảm ơn cậu đã tiêu diệt giúp tôi");
                    break;
                //--------------------------------------------------------------
                ...
                case ConstTask.TASK_27_3:
                    try {
                        InventoryServiceNew.gI().subQuantityItemsBag(player, InventoryServiceNew.gI().findItemBag(player, 16), 1);
                    } catch (Exception ex) {
                    }                    
                    break;
