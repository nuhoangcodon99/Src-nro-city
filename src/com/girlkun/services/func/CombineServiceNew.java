...
public class CombineServiceNew {
 private static final int COST_DAP_DO_KICH_HOAT = 500000000;
    ...
    private static final int RATIO_BONG_TAI3 = 90;
    private static final int RATIO_NANG_CAP3 = 90;
    private static final int RATIO_BONG_TAI4 = 70;
    private static final int RATIO_NANG_CAP4 = 70;
    private static final int RATIO_BONG_TAI5 = 50;
    private static final int RATIO_NANG_CAP5 = 50;
private final Npc baHatMit2;
        ...
        switch (player.combineNew.typeCombine) {
            ...
            case CHE_TAO_TRANG_BI_TS:
                 if (player.combineNew.itemsCombine.size() == 0) {
                    this.npcthiensu65.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Open", "Yes");
                    return;
                }
                ...
                if (player.combineNew.itemsCombine.size() == 1 || player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (dtl != null) {
                        ...
                        npcSay += "|1|" + getNameItemC0(dtl.template.gender, dtl.template.type)
                                + " (ngẫu nhiên kích hoạt)\n|7|Tỉ lệ thành công " + (dhd != null ? "75%" : "50%") + "\n|2|Cần "
                        ...
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần 1 món đồ thần linh của ngươi để có thể chuyển hóa 1", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần 1 món đồ thần linh của ngươi để có thể chuyển hóa 2", "Đóng");
                }
                break;
                ...
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    if (player.combineNew.itemsCombine.size() == 1) {
                        ...
                        if (item != null && item.isNotNullItem() && (item.template.type == 12) &&(item.template.id != 14)&&(item.template.id != 2091) && item.quantity >= 7) {
                            ...
                            this.baHatMit2.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay, "Làm phép", "Từ chối");
                        } else {
    ...
    public void startCombine(Player player) {
     ...
     public void khilv2(Player player, int id){
        ...
        item.itemOptions.add(new ItemOption(50,9));//sd
        item.itemOptions.add(new ItemOption(77,9));//hp
        item.itemOptions.add(new ItemOption(103,9));//ki
   //     item.itemOptions.add(new ItemOption(14,18));//cm
        item.itemOptions.add(new ItemOption(5,9));//sd cm
        InventoryServiceNew.gI().addItemBag(player, item);
        InventoryServiceNew.gI().sendItemBags(player);
    }
    public void khilv3(Player player, int id){
        Item item = ItemService.gI().createNewItem((short)id);
        item.itemOptions.add(new ItemOption(50,12));//sd
        item.itemOptions.add(new ItemOption(77,12));//hp
        item.itemOptions.add(new ItemOption(103,12));//ki
   //     item.itemOptions.add(new ItemOption(14,20));//cm
    ...
    public void khilv4(Player player, int id){
        Item item = ItemService.gI().createNewItem((short)id);
        item.itemOptions.add(new ItemOption(50,15));//sd
        item.itemOptions.add(new ItemOption(77,15));//hp
        item.itemOptions.add(new ItemOption(103,15));//ki
    //    item.itemOptions.add(new ItemOption(14,22));//cm
        item.itemOptions.add(new ItemOption(5,11));//sd cm
        InventoryServiceNew.gI().addItemBag(player, item);
        InventoryServiceNew.gI().sendItemBags(player);
    }
 ...
 //       item.itemOptions.add(new ItemOption(14,24));//cm
        item.itemOptions.add(new ItemOption(5,12));//sd cm
        InventoryServiceNew.gI().addItemBag(player, item);
        InventoryServiceNew.gI().sendItemBags(player);
    }
     public void khilv6(Player player, int id){
        Item item = ItemService.gI().createNewItem((short)id);
        item.itemOptions.add(new ItemOption(50,21));//sd
        item.itemOptions.add(new ItemOption(77,21));//hp
        item.itemOptions.add(new ItemOption(103,21));//ki
  //      item.itemOptions.add(new ItemOption(14,26));//cm
        item.itemOptions.add(new ItemOption(5,13));//sd cm
        InventoryServiceNew.gI().addItemBag(player, item);
        InventoryServiceNew.gI().sendItemBags(player);
    }
   ...
   //     item.itemOptions.add(new ItemOption(14,28));//cm
        item.itemOptions.add(new ItemOption(5,14));//sd cm
        InventoryServiceNew.gI().addItemBag(player, item);
        InventoryServiceNew.gI().sendItemBags(player);
    }
      public void khilv8(Player player, int id){
        Item item = ItemService.gI().createNewItem((short)id);
        item.itemOptions.add(new ItemOption(50,27));//sd
        item.itemOptions.add(new ItemOption(77,27));//hp
        item.itemOptions.add(new ItemOption(103,27));//ki
     //   item.itemOptions.add(new ItemOption(14,27));//cm
            ...
            if (dahoangkim != null && dahoangkim.quantity >= soluongda) {
                if (chanmenh != null && (chanmenh.template.id >= 1351 && chanmenh.template.id < 1359)) {
                     if (Util.isTrue(player.combineNew.TileNangcap, 100)) {
                        ...
                        chanmenh.itemOptions.add(new Item.ItemOption(50, (6 + capbac * 3 - 3)));
                        chanmenh.itemOptions.add(new Item.ItemOption(77, (6 + capbac * 3 - 3)));
                        chanmenh.itemOptions.add(new Item.ItemOption(103, (6 + capbac * 3 - 3)));
        ...
        if (player.combineNew.itemsCombine.size() == 1 || player.combineNew.itemsCombine.size() == 2) {
            ...
            if (dtl != null) {
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0
                    ...
                    player.inventory.gold -= COST_DAP_DO_KICH_HOAT;
                    int tiLe = dhd != null ? 75 : 50;
                    if (Util.isTrue(tiLe, 100)) {
                        sendEffectSuccessCombine(player);
                        Item item = ItemService.gI().createNewItem((short) getTempIdItemC0(dtl.template.gender, dtl.template.type));
        ...
        if (player.combineNew.itemsCombine.size() == 3) {
            ...
            if (bongtai != null && honbongtai != null && honbongtai.quantity >= 99) {
                ...
                if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                    ...
                    if (rdUp == 0) {
                        bongtai.itemOptions.add(new Item.ItemOption(50, Util.nextInt(0, 10)));
                    } else if (rdUp == 1) {
                        bongtai.itemOptions.add(new Item.ItemOption(77, Util.nextInt(0, 10)));
                    } else if (rdUp == 2) {
                        bongtai.itemOptions.add(new Item.ItemOption(103, Util.nextInt(0, 10)));
                    } else if (rdUp == 3) {
                        bongtai.itemOptions.add(new Item.ItemOption(94, Util.nextInt(0, 10)));
                    } else if (rdUp == 4) {
                        bongtai.itemOptions.add(new Item.ItemOption(80, Util.nextInt(0, 10)));
                    } else if (rdUp == 5) {
                        bongtai.itemOptions.add(new Item.ItemOption(81, Util.nextInt(0, 10)));
                    }
                    sendEffectSuccessCombine(player);
                } else {
                    sendEffectFailCombine(player);
        ...
        if (player.combineNew.itemsCombine.size() == 3) {
            ...
            if (bongtai != null && honbongtai != null && honbongtai.quantity >= 99) {
                ...
                if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                    ...
                    int rdUp = Util.nextInt(0, 5);
                    if (rdUp == 0) {
                        bongtai.itemOptions.add(new Item.ItemOption(50, Util.nextInt(10, 20)));
                    } else if (rdUp == 1) {
                        bongtai.itemOptions.add(new Item.ItemOption(77, Util.nextInt(10, 20)));
                    } else if (rdUp == 2) {
                        bongtai.itemOptions.add(new Item.ItemOption(103, Util.nextInt(10, 20)));
                    }  else if (rdUp == 3) {
                        bongtai.itemOptions.add(new Item.ItemOption(94, Util.nextInt(10, 20)));
                    }  else if (rdUp == 4) {
                        bongtai.itemOptions.add(new Item.ItemOption(80, Util.nextInt(10, 20)));
                    } else if (rdUp == 5) {
                        bongtai.itemOptions.add(new Item.ItemOption(81, Util.nextInt(10, 20)));
                    }
                    sendEffectSuccessCombine(player);
                } else {
                    sendEffectFailCombine(player);
        ...
        if (player.combineNew.itemsCombine.size() == 3) {
            ...
            if (bongtai != null && honbongtai != null && honbongtai.quantity >= 99) {
                ...
                if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                    ...
                    int rdUp = Util.nextInt(0, 5);
                    if (rdUp == 0) {
                        bongtai.itemOptions.add(new Item.ItemOption(50, Util.nextInt(15, 25)));
                    } else if (rdUp == 1) {
                        bongtai.itemOptions.add(new Item.ItemOption(77, Util.nextInt(15, 25)));
                    } else if (rdUp == 2) {
                        bongtai.itemOptions.add(new Item.ItemOption(103, Util.nextInt(15, 25)));
                    } else if (rdUp == 3) {
                        bongtai.itemOptions.add(new Item.ItemOption(94, Util.nextInt(15, 25)));
                    } else if (rdUp == 4) {
                        bongtai.itemOptions.add(new Item.ItemOption(80, Util.nextInt(15, 25)));
                    } else if (rdUp == 5) {
                        bongtai.itemOptions.add(new Item.ItemOption(81, Util.nextInt(15, 25)));
                    }
                    sendEffectSuccessCombine(player);
                } else {
                    sendEffectFailCombine(player);
   ...
   private boolean isDaPhaLe(Item item) {
    ...
    private boolean isTrangBiPhaLeHoa(Item item) {
        if (item != null && item.isNotNullItem()) {
            if (item.template.type < 5 || (item.template.id >= 529&& item.template.id <= 531)) {
                return true;                    
