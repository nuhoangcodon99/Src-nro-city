...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_MAP_14h = "Ma nhưng bơ sắp được hồi sinh "
            + "vào lúc 2h"
            + " hàng ngày hãy giải cứu thế giới";
    public static final String NPC_TORI = "|1|Xin chào, Tori-Bot tôi sẽ hướng dẫn bạn đổi xu HRZ..\n"
            + "|1|Như bạn thế giới chúng tôi sử dụng 4 loại tiền tệ chính\ngồm: |2|Vàng, Ngọc xanh, Ngọc Hồng, và Xu HRZ\n";
    public static final String NPC_OSIN = "Ngươi muốn đến Vùng Đất của các Vị Thần ư?..\n"
            + "Yêu cầu ngươi phải có mức sức mạnh 40 tỷ mới có đủ sức để đi đến đó và gặp gỡ các vị thần..\n"
            + "Nếu đủ yêu cầu ta sẽ dẫn ngươi đi đến Vùng Đất của các Vị Thần..";
    public static final String NPC_BUMMA = "Chào cậu, tôi sẽ hướng dẫn cậu về khu vực luyện tập sau làng..\n"
            + "Ở khu luyện tập sẽ phân thành 2 khu: sơ sinh và trung cấp..\n"
            + "Để vào được khu sơ sinh cần sức mạnh từ 500k đến 5 triệu sức mạnh..\n"
            + "Để vào được khu Trung cấp cần sức mạnh từ 5 triệu đến 1 tỷ 5 sức mạnh..\n"
            + "Ở trong khu luyện tập tiềm năng và sức mạnh sẽ được x2..\n"
            + "Các vật phẩm hỗ trợ có tỷ lệ rớt tăng cao..\n"
            + "Tỷ lệ rớt trang bị Kích Hoạt và trang bị Sao Pha lê tăng cao..\n"
            + "Đồng thời mỗi 1 giờ sẽ có các Boss phản diện xuất hiện.."
            + "Khi tiêu diệt được Boss phản diện sẽ có tỷ lệ nhận được: găng tay trang bị Kích Hoạt, Sao Pha Lê từ 4 đến 8 sao..\n"
            + "Chúc bạn luyện tập nhiều may mắn..";
    public static final String NPC_DHVT23 = "Đại hội quy tụ nhiều cao thủ như là Jacky CHun, Thiên Xin Hăng, Tàu Bảy Bảy...\n"
    ...
    public static final byte BA_HAT_MIT = 21;
     public static final byte BA_HAT_MIT2 = 52;
     public static final byte Yardrat = 106;
    ...
    public static final byte NAMI = 98;
    public static final byte OBITO = 101;
    ...
    public static final byte MAI = 93;
    public static final byte DAI = 89;
    public static final byte FU = 90;
    public static final byte TELE = 104;
   ...
   // public static final byte GOKU_SSJ = 60;
    ...
    //index quy lão kamê
    public static final int HOTRO = 5899;
    ...
    public static final int CONFIRM_DOI_DIEM_DUA = 528;
    public static final int CONFIRM_DOI_DIEM_ITEMC2 = 529;
    public static final int CONFIRM_DOI_DIEM_CT = 530;
    public static final int CONFIRM_DOI_ITEM_NR = 531;

    //index than vu tru
    public static final int MENU_OPEN_KGHD = 528;
    public static final int MENU_OPENED_KGHD = 529;
    public static final int MENU_ACCEPT_GO_TO_KGHD = 530;
    
    //index mi nuong
    public static final int MENU_OPEN_BTDN = 534;
    public static final int MENU_OPENED_BTDN = 535;
    public static final int MENU_ACCEPT_GO_TO_BTDN = 536;
    
   // public static final int CALL_BOSS = 599;
    
public static final int MENU_OPEN_CDRD = 531;
    public static final int MENU_OPENED_CDRD = 532;
    public static final int MENU_ACCEPT_GO_TO_CDRD = 533;
    ...
    public static final int MENU_NANG_CAP_LINH_THU = 508;
    public static final int MENU_BONG_TAI_2 = 5002;
    public static final int MENU_BONG_TAI_3 = 5020;
    public static final int MENU_BONG_TAI_4 = 50002;
    public static final int MENU_BONG_TAI_5 = 500002;
    public static final int MENU_TX_HN = 112;
    public static final int MENU_TX_TV = 1122;
    ...
    public static final int MENU_ADMIN1 = 51002;
    public static final int BAN_PLAYER = 513;
    public static final int BUFF_PET = 514;
    public static final int MENU_BOSSV1 = 592;
    public static final int CALL_BOSS = 998;
...
//    public static final int CONFIRM_ACTIVE = 518;
    ...
    public static final int SHENRON_3 = 505;
     ...
     public static final int TUTORIAL_SUMMON_DRAGONTRB = 535;
      
     public static final int SUMMON_SHENRONTRB = 536;
     
     public static final int SHENRONTRB = 537;
    ...
    public static final int MENU_SO_4 = 501;
    ...
    public static final int RUONG_PHU = 999;
}
