...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final short[] itemIds_CUI = {233, 237, 241 ,245, 249, 253 ,257, 261, 265 ,269, 273, 277 ,281, 16, 17, 18};//          áo       quần      găng       giày     áo       quần      găng       giày       áo       quần      găng       giày    9    10   11   12
    public static final short[] itemIds_TL = {555, 557, 559, 556, 558, 560, 562, 564, 566, 563, 565, 567, 561};
    public static final byte[] itemIds_NR_SC = {15, 16, 17, 18, 19};
    ...
    public static final short[] itemC2 = {1099, 1100, 1101, 1102};
    //public static final short[] thucan = {663, 664, 665, 666, 667};
    public static final short[] SuKien_TrungThu = {1338, 1339, 1340};
    public static final short[] itemIds_HD = {650, 651, 652, 653, 654, 655, 656, 657, 658, 659, 660, 661, 662};
    ...
    private Manager() {
        ...
        this.initMap();
//        ArchivementManager.getInstance().init();
        ...
        new Thread(() -> {
            try {
                while (!Maintenance.isRuning) {
                    ...
                    MAPS.forEach(new Consumer<com.girlkun.models.map.Map>() {
                        @Override
                        public void accept(com.girlkun.models.map.Map map) {
                ...
                if (!fileEntry.isDirectory()) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (item.getTemp().type == 30) { // sao pha lê
                            item.setRatio(new int[]{10, Integer.parseInt(ratio[1])});
                        }
...
//                    dataArray.clear();
            ...
            while (rs.next()) {
                ...
                ShopKyGuiManager.gI().listItem.add(new ItemKyGui(i, itemId, idPl, tab, gold, ruby, quantity, isUp, op, isBuy));
            }
            ...
            while (rs.next()) {
                ...
                switch (query) {
                    case queryTopSM:
                        ...
                        top.setInfo2(rs.getLong("id") + " (ID Player)");
                        break;
                    case queryTopNV:
                    ...
                    case queryTopPVP:
                        ...
                        top.setInfo2(rs.getInt("pointPVP") + " Điểm PvP");
                        break;
                    case queryTopSD:
                        top.setInfo1(rs.getInt("sd") + "");
                        top.setInfo2(rs.getInt("sd") + "");
                        break;
                }
                tops.add(top);
            }
