        ...
        try {
            ...
            switch (cmd) {
                ...
                case -101:
                    ...
                    break;
                case -118:
                    int idBoss = _msg.reader().readInt();
                    BossManager.gI().timBoss(player, idBoss);
                    break;
                case -103:
                    if (player != null) {
                ...
                case -66:
                    ...
                    int idT = effId;
                    if (effId == 25 && SummonDragon.gI().playerSummonShenron.zone.map.mapId == 170) {
                        idT = 25; // id eff rong muon thay doi ( hien tai la rong xuong) 
                    }
...
//                                Service.gI().sendThongBao(player, "Đang bảo trì...");
            ...
            try {
                ...
                switch (cmd) {
                    case 0:
                        ...
                        Logger.log(Logger.BLUE, "Phiên bản sử dụng:" + msg.readUTF() + " \n");
                        break;
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với Chú Bé Rồng City\n"
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player, "Chú Bé Rồng City\nxin chào các bạn !!");
    }
